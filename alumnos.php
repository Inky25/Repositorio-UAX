...
<body class="bg-light">
    <div class="container mt-5">
        <div class="card shadow p-4">
            <h1 class="text-center text-primary">Inserta los datos del alumno</h1>
            <form action="./insalumnos.php" method="POST" class="mt-3">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="number" placeholder="Teléfono" class="form-control" name="Telefono" required />
                </div>
